...
# Start transcript
Start-Transcript -Path $env:temp\Install-OcspServer.log

# Install OCSP role and configure
Write-Verbose 'Installing Online Responder role service...'
[void](Install-WindowsFeature ADCS-Online-Cert -IncludeManagementTools)
...
Set-NetFirewallRule -DisplayName "Online Responder Service (DCOM-In)" -Profile Any -Enabled True
Set-NetFirewallRule -DisplayName "Online Responder Service (RPC-In)" -Profile Any -Enabled True
Set-NetFirewallRule -DisplayName "Online Responder Service (TCP-Out)" -Profile Any -Enabled True
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQU+AZVluwuXxgjK9dNRE55eKwY
# 1UagghpiMIIDWTCCAt+gAwIBAgIQD7inQLkVjQNRQ7xZ2fBAKTAKBggqhkjOPQQD
...
# HAYKKwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFDss
# 2ISG5nbLshBV1vX+G4X5ifqkMAsGByqGSM49AgEFAARIMEYCIQC07uO3n2D5XNiv
# kMZM8VXJptFLLT7hu1k1GDR7qv7jGgIhALCdkAFnRwqnbqHFtPun+doub2wetlDk
# 5WD65CCpEhCooYIDIDCCAxwGCSqGSIb3DQEJBjGCAw0wggMJAgEBMHcwYzELMAkG
# A1UEBhMCVVMxFzAVBgNVBAoTDkRpZ2lDZXJ0LCBJbmMuMTswOQYDVQQDEzJEaWdp
# Q2VydCBUcnVzdGVkIEc0IFJTQTQwOTYgU0hBMjU2IFRpbWVTdGFtcGluZyBDQQIQ
# C65mvFq6f5WHxvnpBOMzBDANBglghkgBZQMEAgEFAKBpMBgGCSqGSIb3DQEJAzEL
# BgkqhkiG9w0BBwEwHAYJKoZIhvcNAQkFMQ8XDTI0MTIxNTAzNTQxMlowLwYJKoZI
# hvcNAQkEMSIEIIcQM6ZuKtufjwrNFBlO9rjJrazOqHGakTrUNziVaS6yMA0GCSqG
# SIb3DQEBAQUABIICAK9DzYBi/oBzEcTKaVloeFYVIBjILSKNISg11DMIDPnKIPLU
# imxSDYN/AkoaLgf2zkiquTHYxeKDnOmGOlV7yBJIp+VoIDI0BvR+sEHZrGpn2Qai
# YPyFQmz7b2XAL2+HBv4VhVj03+41hq/BWV0XQRFveL8zPHa7CjZq26DuceHNi5XJ
# nB+2j+pzdxuPugi/Isi9BOxTrTkiptPaJahIR4JdbX9+au74gvocYOLkTqNVBT0I
# IcyYwl8ul/U1Y49J49rYU6Sf35P9uc5HR9+9+mSzxM2ASoMvg0yWnJqWcP47Tu/U
# Up+yLpulh9/rABFnPwmAC5oKYuWWPwUNQ4eXh1jzfJ404PMG1Fo+XHft3qsIKDXl
# s1B8eG2ncLh+cVxuRDSIm7tN76pLcD3Tf7J3fD/wqewOudnbqn3uhOGQDkg6c/Au
# z88olpfQkJwMRwzFH996pGjbi59qiW648PCq4k/dAvPx3gYN+vu3NCFuHUEXpJD0
# VkRZ4o//lYLnjj0L3hTNy8scZHgBGDRfNsUFgVebzthKKgfw6BfKWkUk+a5OCx7s
# Cm4YZ9tjtBqYKTEUlp6uKVKTWVB1t6mryDyrL0et6tsqDKbv/Kw27Y3vahVuCCLe
# tmXuNFygsRBVviMlRKxGEvQpvEF9SOAi1GuK02J8+H04o/X/BWP49QXiyVto
